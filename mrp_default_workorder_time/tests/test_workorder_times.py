...
class TestMrpDefaultWorkorderTime(TestMrpCommon):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.bom_2.type = "normal"

    def _create_production_with_workorders(
    ...
    def test_mrp_default_workorder_time(self):
        ...
        mo = self._create_production_with_workorders(1)
        ...
        mo2 = self._create_production_with_workorders(
        ...
        mo3 = self._create_production_with_workorders(
            1, True, mo.company_id.minimum_order_time_threshold
        )
        ...
        mo4 = self._create_production_with_workorders(
        ...
        mo5 = self._create_production_with_workorders(
        ...
        mo6 = self._create_production_with_workorders(
